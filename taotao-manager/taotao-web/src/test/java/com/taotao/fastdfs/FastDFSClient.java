...
public class FastDFSClient {
	...
	public FastDFSClient(String conf) throws Exception {
		...
		String g_secret_key = ClientGlobal.g_secret_key;
		System.out.println(g_secret_key);
	...
	public String getURL(String[] result) {
		return "http://" + ClientGlobal.getG_tracker_group().tracker_servers[0].getHostName() + "/" + result[0] + "/"
				+ result[1];
	}
}
